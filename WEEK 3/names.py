...
def extract_given_name(full_name):
    ...
    # return given_name
    separated_names = full_name.split("; ")
    return separated_names[1]

def main():
    name = input("What is your name: ")
    separated_given_name = extract_given_name(name)
    separated_family_name = extract_family_name(name)

    print(f"Your name is {separated_given_name} and your family name is {separated_family_name} ")
